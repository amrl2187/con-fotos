...
function loadProducts() {
    ...
    const allProducts = [
        { store: 'amazon', name: "Producto Amazon 1", image: "gamers.jpg", description: "Descripción del Producto Amazon 1" },
        { store: 'aliexpress', name: "Producto AliExpress 1", image: "procesador.png", description: "Descripción del Producto AliExpress 1" },
